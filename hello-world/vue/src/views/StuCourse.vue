<template>
  <div>
    ...
    <el-table :data="courses" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="100"></el-table-column>
      <el-table-column prop="id" label="ID" width="100"></el-table-column>
      <el-table-column prop="name" label="课程名" ></el-table-column>
      <el-table-column prop="times" label="课时" width="100"></el-table-column>
      <el-table-column prop="score" label="学分"width="200"></el-table-column>
  ...
  methods: {
    ...
    load() {
      this.request.get("/user/page", {
        ...
        this.courses=this.tableData[0].stuCourses
/*        console.log(this.courses)
/!*        console.log(this.tableData)
        console.log(this.tableData.courses)*!/*/
