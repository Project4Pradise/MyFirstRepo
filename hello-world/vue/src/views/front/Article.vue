...
<template>
  <div>
    ...
    <div style="margin: 20px 0">
        <div style="margin: 10px 0;border-bottom: 1px dashed #eee" v-for="item in tableData" :key="item.id">
          ...
          <div style="font-size: 14px;margin-top: 10px">
            ...
            <i class="el-icon-user-time" style="margin-left: 10px"></i><span>{{item.time}}</span>
          </div>
        </div>
    </div>
